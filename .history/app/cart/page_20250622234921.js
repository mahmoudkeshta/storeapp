        ...
        {loading ? (
          ...
          {cartItems.map((item) => (
            <Link
              ...
              to={`/category/home/${item.product_id}`} // المسار الديناميكي لصفحة التفاصيل
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    <button
                      onClick={(e) => {
                        e.preventDefault(); // لمنع التنقل عند النقر على الزر
                ...
                <button
                  onClick={(e) => {
                    e.preventDefault(); // لمنع التنقل عند حذف العنصر
