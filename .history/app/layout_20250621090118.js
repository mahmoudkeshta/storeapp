    ...
    <html lang="ar" dir="ltr">
      ...
      >
        ...
        >
          ...
          >
           {/* ايقونة عربة التسوق كرابط */}
           <Link href="/cart" style={{ cursor: "pointer", textDecoration: "none", color: "inherit", fontSize: "24px" }}>
        🛒
      </Link>

      {/* ايقونة القلب كرابط */}
      <Link href="/favorites" style={{ cursor: "pointer", textDecoration: "none", color: "inherit", fontSize: "24px" }}>
        ♡
      </Link>
    </div>
            <span
