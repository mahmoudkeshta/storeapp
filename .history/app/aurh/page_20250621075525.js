...
export default function Auth() {
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center bg-gray-900">
      ...
      {/* رسالة الخطأ في مركز الشاشة وبشكل Overlay */}
      {errorMessage && (
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-red-600 bg-opacity-90 text-white px-6 py-4 rounded-lg shadow-lg font-bold z-50">
          {errorMessage}
        </div>
      )}
