...
export default function Auth() {
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center bg-gray-900">
      ...
      {/* رسالة الخطأ في أسفل الشاشة */}
      {errorMessage && (
        <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-red-600 text-white px-6 py-3 rounded-full shadow-lg font-semibold z-50 max-w-[90vw] text-center">
          {errorMessage}
        </div>
      )}
