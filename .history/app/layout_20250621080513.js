...
export default async function RootLayout({ children }) {
  ...
  return (
    <html lang="ar" dir="rtl">
      ...
      >
        {/* الشريط العلوي */}
        <header className="bg-warning d-flex justify-content-between align-items-center px-3" style={{ height: 60 }}>
        ...
        {/* شريط الأقسام */}
        <nav className="d-flex justify-content-between align-items-center px-5 border-bottom bg-white flex-wrap" style={{ gap: "1rem" }}>
          {/* الشعار */}
          <div className="d-flex align-items-center gap-2 cursor-pointer">
            <span className="fs-3 text-warning" style={{ fontWeight: "700" }}>
              ن
            </span>
