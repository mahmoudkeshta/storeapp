...
export default function PostPage() {
  ...
  const [cartOpen, setCartOpen] = useState(false); // حالة ظهور قائمة السلة
  const debounceTimeout = useRef(null);

  // عينة عربة التسوق (يمكن تستبدلها بالداتا الحقيقية)
  ...
  return (
    ...
    >
      ...
      >
        <h3 style={{ marginBottom: "rtl", color: "#333" }}>الفلاتر</h3>
      ...
      {/* قائمة السلة على اليسار */}
      <aside
        style={{
          width: cartOpen ? "300px" : "0",
          backgroundColor: "#fff",
          borderRight: cartOpen ? "1px solid #ddd" : "none",
