...
export default function PostPage({ params }) {
  ...
  const [likedProducts, setLikedProducts] = useState({}); // key: product_id, value: true/false
          ...
          {filteredProducts.map((product) => (
            <div
              ...
              style={{
                ...
                height: "420px", // شوي زيادة عشان نضيف زر
            ...
            >
              ...
              <div style={{ display: "flex", gap: "10px", marginTop: "auto" }}>
                ...
                <button
                  ...
                  style={{
                    padding: "12px 15px",
                    backgroundColor: likedProducts[product.product_id] ? "#e53935" : "#eee",
                    border: "none",
                    borderRadius: "30px",
                    color: likedProducts[product.product_id] ? "white" : "#555",
                    fontSize: "20px",
                    cursor: "pointer",
                    transition: "background-color 0.3s ease",
                    display: "flex",
                  ...
                  aria-label={likedProducts[product.product_id] ? "Liked" : "Not liked"}
                >
