...
export default function PostPage({ params }) {
  ...
  const [likedItems, setLikedItems] = useState({}); // لتتبع الإعجابات

  // معرف المستخدم - استبدل بالمعرف الحقيقي أو من الجلسة
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    fontSize: "24px",
                    color: likedItems[product.product_id] ? "red" : "#aaa",
                    transition: "color 0.3s ease",
                    padding: 0,
                    lineHeight: 1,
                  }}
                  aria-label="زر الإعجاب"
                  title={likedItems[product.product_id] ? "تم الإعجاب" : "أعجبني"}
                >
