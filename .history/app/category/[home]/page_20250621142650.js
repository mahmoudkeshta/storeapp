...
export default function PostPage({ params }) {
  ...
  // معرف المستخدم (مثال ثابت، استبدل بالديناميكي)
  const userId = "8";
  ...
  // دالة إرسال المنتج للسلة في السيرفر
        ...
        >
          {filteredProducts.map((product) => (
            ...
            >
              ...
              {/* زر السلة تحت الصورة وعلى اليمين */}
              <div
                style={{
                  display: "flex",
